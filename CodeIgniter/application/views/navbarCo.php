<nav class="navigation2" id="bar_navigation">
    ...
    <ul id="liste_navbar">
        <li onclick="location.href='<?= site_url("accueil")?>'" onmouseover="bouton_navbar_hover(0)" onmouseleave="bouton_navbar_hover_end()" <?php if($active == 1):?> id="activated" <?php endif; ?> >
            <p>Accueil</p>
        </li>
        <li onclick="location.href='<?= site_url("ecole")?>'" onmouseover="bouton_navbar_hover(1)" onmouseleave="bouton_navbar_hover_end()" <?php if($active == 2):?> id="activated" <?php endif; ?>>
            <p>Ecole</p>
        </li>
        <li onclick="location.href='#'" onmouseover="bouton_navbar_hover(2)" onmouseleave="bouton_navbar_hover_end()" <?php if($active == 3):?> id="activated" <?php endif; ?> >
            <p>S'installer</p>
        </li>
        <li onclick="location.href='<?= site_url("administratif")?>'" onmouseover="bouton_navbar_hover(3)" onmouseleave="bouton_navbar_hover_end()"<?php if($active == 4):?> id="activated" <?php endif; ?>  >
            <p>Administratif</p>
        </li>
        <li onclick="location.href='<?= site_url("histoire")?>'" onmouseover="bouton_navbar_hover(4)" onmouseleave="bouton_navbar_hover_end()" <?php if($active == 5):?> id="activated" <?php endif; ?>>
